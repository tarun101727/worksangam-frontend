...
{openMenuId === m._id && (
  <div className="absolute top-5 -right-7 bg-[#0f172a] border border-white/10 rounded-lg shadow-xl z-50 min-w-[130px]">
...
{openMenuId === m._id && (
  <div className="absolute top-5 -left-7 bg-[#0f172a] border border-white/10 rounded-lg shadow-xl z-50 min-w-[130px]">
