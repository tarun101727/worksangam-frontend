...
{openMenuId === m._id && (
  <div className="absolute top-8 -right-[20px] bg-[#0f172a] border border-white/10 rounded-lg shadow-xl z-50 min-w-[130px]">
...
{openMenuId === m._id && (
  <div className="absolute top-8 -left-[45px] bg-[#0f172a] border border-white/10 rounded-lg shadow-xl z-50 min-w-[130px]">
