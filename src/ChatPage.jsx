...
{showScrollDown && (
  <button
    ...
    className="fixed bottom-24 right-5 z-50 w-12 h-12 rounded-full bg-indigo-500 hover:bg-indigo-600 shadow-xl flex items-center justify-center animate-bounce"
  >
    <svg
