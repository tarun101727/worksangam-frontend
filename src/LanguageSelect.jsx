...
const LanguageSelect = () => {
  ...
  try {
    // Wait for i18next to fully load the language
    ...
    // Navigate only after language is fully loaded
    navigate("/signup");
  } catch (err) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#020617] via-[#0a0d21] to-[#020617] text-white px-4 py-12">
      <div className="bg-[#0F172A]/90 backdrop-blur-md p-8 sm:p-10 rounded-3xl shadow-2xl w-full max-w-lg text-center border border-gray-700">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-5 sm:gap-6">
          {[
            ...
            <button
              ...
              className="py-3 sm:py-4 px-4 rounded-2xl bg-gray-800 hover:bg-gray-700 active:bg-gray-600 transition-all duration-200 shadow-md hover:scale-105 font-medium text-sm sm:text-base"
            >
              {lang.label}
            </button>
          ))}
