...
const submit = async () => {
  ...
  try {
    ...
    // ✅ Navigate to Online Worker Urgent Posts page
    navigate("/online-worker-urgent-posts");
  } catch {
...
>
  {loading
    ? "Please wait..."
    : `Search for online${form.profession ? ` ${form.profession}` : ""}`}
</button>
...
export default HirerOnlineUrgentPost;